  ...
  return (
    <div className='w-screen h-screen grid place-content-center'>
      ...
      <div className='flex flex-col gap-4 justify-center items-center'>
        <div className='flex h-12 w-max justify-center items-center border-[#3594ca] border-2 px-4 rounded-md gap-3'>
      <input className='lg:w-[30rem] w-[100%]  h-8 pl-2 rounded-lg text-[#3594ca] bg-transparent border-[#3594ca] border-2 outline-none' placeholder='Enter any City or Country' type="text"
      value={city}
