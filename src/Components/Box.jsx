...
const Box = ({img, time,level}) => {
  return (
    <div className='flex justify-center items-center w-20 min-w-[5rem] flex-col bg-black bg-opacity-[0.35] rounded-lg gap-1 border-white border-opacity-30 border-[1px]'> 
